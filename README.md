...
**基于 Spring Boot + Vue3 的前后端分离后台管理系统**
...
<p align="center">
  ...
  <img src="https://gitee.com/zhijiantianya/ruoyi-vue-pro/badge/star.svg?theme=white" alt="Gitee stars">
</p>
...
| 版本类型 | 技术栈 | 演示地址 | 文档链接 |
|---------|--------|----------|----------|
| **Vue3 + Element Plus** | Vue3 + TypeScript | [🌐 在线体验](http://dashboard-vue3.yudao.iocoder.cn) | [📖 启动文档](https://doc.iocoder.cn/quick-start/) |
| **Vue3 + Vben (Ant Design)** | Vue3 + TypeScript | [🌐 在线体验](http://dashboard-vben.yudao.iocoder.cn) | [📹 视频教程](https://doc.iocoder.cn/video/) |
| **Vue2 + Element UI** | Vue2 + JavaScript | [🌐 在线体验](http://dashboard.yudao.iocoder.cn) | - |
...
> 📖 参考 [《迁移文档》](https://doc.iocoder.cn/migrate-module/)，只需要 5-10 分钟，即可将【完整版】按需迁移到【精简版】
...
2. **导入数据库**
   ```bash
   # 执行 sql/mysql/ruoyi-vue-pro.sql 脚本
   mysql -u root -p < sql/mysql/ruoyi-vue-pro.sql
   ```

3. **启动后端服务**
   ```bash
   # 使用 IDEA 打开项目，启动 YudaoServerApplication
   # 或使用 Maven 命令
   mvn spring-boot:run
   ```
...
> 📖 **详细教程**：[完整启动文档](https://doc.iocoder.cn/quick-start/) | [视频教程](https://doc.iocoder.cn/video/)
...
<div align="center">
  <img src="/.image/common/ruoyi-vue-pro-architecture.png" alt="架构图" style="max-width: 100%;">
</div>

### 🌟 核心特性

- **🏗️ 架构先进**：Java 后端采用 Spring Boot 多模块架构，前端提供 Vue2/Vue3 多种选择
- **🔒 安全可靠**：采用 Spring Security + JWT + Redis 权限认证，支持多终端、多用户认证
- **🏢 多租户支持**：支持 SaaS 多租户，可自定义每个租户的权限，提供透明化的多租户底层封装
- **📊 数据库兼容**：支持 MySQL、Oracle、PostgreSQL、SQL Server、MariaDB、国产达梦 DM、TiDB 等
- **🔄 工作流引擎**：基于 Flowable，支持动态表单、在线设计流程、会签/或签、多种任务分配方式
- **⚡ 高效开发**：代码生成器一键生成 Java、Vue 前后端代码、SQL 脚本、接口文档
- **🔗 实时通信**：采用 Spring WebSocket 实现，内置 Token 身份校验，支持 WebSocket 集群
- **💳 支付集成**：集成支付宝、微信等支付与退款，支持多种支付场景
- **☁️ 云服务集成**：集成阿里云、腾讯云等短信渠道，MinIO、七牛云等云存储服务
- **📈 可视化报表**：集成报表设计器、大屏设计器，通过拖拽即可生成酷炫的报表与大屏
...
<div align="center">
  <img src="/.image/common/yudao-roadmap.png" alt="架构演进" style="max-width: 100%;">
</div>
...
<div align="center">
  <img src="/.image/common/ruoyi-vue-pro-biz.png" alt="功能分层" style="max-width: 100%;">
</div>
...
- **项目主页**：[Gitee](https://gitee.com/zhijiantianya/ruoyi-vue-pro) | [GitHub](https://github.com/YunaiV/ruoyi-vue-pro)
- **官方文档**：[https://doc.iocoder.cn](https://doc.iocoder.cn)
- **问题反馈**：[Gitee Issues](https://gitee.com/zhijiantianya/ruoyi-vue-pro/issues) | [GitHub Issues](https://github.com/YunaiV/ruoyi-vue-pro/issues)
- **商务合作**：微信联系【**Aix9975**】
...
<a href="https://gitee.com/zhijiantianya/ruoyi-vue-pro">
  <img src="https://gitee.com/zhijiantianya/ruoyi-vue-pro/widgets/widget_3.svg" alt="Fork me on Gitee">
</a>
