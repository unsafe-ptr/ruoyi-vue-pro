...
1.  **准备工作**
    ...
    - 安装 MySQL 5.7+
    - 安装 Maven
    - 下载 [代码](https://gitee.com/zhijiantianya/ruoyi-vue-pro) 到本地
2.  **启动后端**
    - 使用 IDEA 打开项目 `ruoyi-vue-pro`
    - 在 `sql/mysql` 目录下找到 `ruoyi-vue-pro.sql` 和 `quartz.sql`，导入数据库
    - 修改 `yudao-server` 模块下的 `application-local.yml` 配置文件，设置数据库和 Redis 连接信息
    - 运行 `YudaoServerApplication.java` 即可启动后端
3.  **启动前端**
    - 本项目提供了多个前端实现，请根据需要选择
    - [yudao-ui-admin-vue3 (Element Plus)](https://gitee.com/yudaocode/yudao-ui-admin-vue3)
    - [yudao-ui-admin-vben (Ant Design Vue)](https://gitee.com/yudaocode/yudao-ui-admin-vben)
    - [yudao-ui-admin-vue2 (Element UI)](https://gitee.com/yudaocode/yudao-ui-admin-vue2)
    - 进入对应前端项目，参考其 `README.md` 的说明启动。

更详细的文档请参考 [快速启动](https://doc.iocoder.cn/quick-start/)。

## 🤝 如何贡献

非常欢迎您对本项目进行贡献！

- **提交 Issue**：如果您在使用中遇到任何问题，或者有任何好的建议，欢迎在 [Gitee Issues](https://gitee.com/zhijiantianya/ruoyi-vue-pro/issues) 中提出。
- **提交 Pull Request**：
    1. Fork 本仓库
...
*项目基于 [RuoYi-Vue](https://gitee.com/y_project/RuoYi-Vue) 修改，感谢其优秀的设计和代码！*
